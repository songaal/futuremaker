...
class BitfinexWS(object):

    # Don't grow a table larger than this amount. Helps cap memory usage.
    MAX_TABLE_LEN = 200

    def __init__(self, symbol, candle_period=None, api_key=None, api_secret=None):
        ...
        private_topic = ['margin',
                         f'order:{symbol}',
                         f'position:{symbol}']
        public_topic = '{ "event": "subscribe",  "channel": "candles",  "key": "trade:1m:tBTCUSD" }'
